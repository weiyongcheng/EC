...
import com.wei.latte.net.callback.IRequest;
...
public class RestClientBuilder {
    ...
    public final RestClient build() {
        return new RestClient(mUrl, PARAMS, mIRequest, mISuccess, mIFailure, mIError, mBody, mFile, mDownloadDir, mExtention, mName, mContext, mLoaderStyle);
    }
}
