package com.wei.latte.ec.main.cart;
...
import com.wei.latte.ec.pay.FastPay;
import com.wei.latte.ec.pay.IAliPayResultListener;
...
public class ShopCartDelegate extends BottomItemDelegtate implements ISuccess, ICartItemListener, IAliPayResultListener {
    ...
    void onClickSelectAll() {
        ...
        if (tag == 0) {
            ...
            //更新RecyclerView的显示状态
//            mAdapter.notifyDataSetChanged(); 一次性更新全部ui，不推荐
    ...
    void onClickRemoveSelectedItem() {
        ...
        for (MultipleItemEntity entity: deleteEntities) {
            ...
            if (removePosition <= mAdapter.getItemCount()) {
                ...
                Toast.makeText(getContext(), "removePostion: " + removePosition + ", mAdapter.getItemCount: " + mAdapter.getItemCount(), Toast.LENGTH_LONG).show();
            }
        }
        checkItemCount();
    }
    ...
    private void createOrder() {
        ...
        orderParams.put("isannymous", true);
                ...
                .success(new ISuccess() {
                    ...
                    public void onSuccess(String response) {
                        ...
                        FastPay.create(ShopCartDelegate.this)
                                //todo 必须写成ShopCartDelegate.this，不能写this，不然会报错
